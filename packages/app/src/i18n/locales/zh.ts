...
export default {
  ...
  "session.default_header_title": "探索并发现可用主题",
  "session.empty_title": "Hello World，Welcome to Crow5",
  "session.empty_description": "选择一个快捷动作，或直接在下方输入需求。",
  "session.empty_hint_title": "快捷按钮已移动到顶部",
  "session.empty_hint_description": "请在右上角 Cmd+K 左侧使用开始、编译、运行、打开浏览器。",
  "session.quickstart.start_title": "开始",
  "session.quickstart.start_description": "分析当前项目并给出可执行的启动计划。",
  "session.quickstart.start_prompt": "请先检查当前项目结构与依赖，然后给我一个清晰的启动实施计划。",
  "session.quickstart.build_title": "编译",
  "session.quickstart.build_description": "执行正确的构建/编译命令并反馈结果。",
  "session.quickstart.build_prompt": "请执行这个项目正确的构建/编译命令，并逐步修复构建错误。",
  "session.quickstart.run_title": "运行",
  "session.quickstart.run_description": "启动项目并确认服务可正常访问。",
  "session.quickstart.run_prompt": "请运行这个项目，确认启动日志正常，并告诉我访问地址。",
  "session.quickstart.open_browser_title": "打开浏览器",
  "session.quickstart.open_browser_description": "快速打开本地预览（自动尝试 5173/3000/8080）。",
  "session.quickstart.open_browser_chat_prompt":
    "请帮我在浏览器中打开当前本地运行的网站，优先尝试常见端口（5173/3000/8080），并告诉我最终访问地址。",
  "session.quickstart.open_browser_chat_prompt_with_url":
    "请使用浏览器打开 {url}，确认页面是否加载成功，并告诉我你看到的内容。",
  "session.quickstart.open_browser_prompt": "请输入要打开的 URL",
  "session.quickstart.browser_opened": "已在浏览器中打开。",
  "session.quickstart.browser_blocked": "浏览器弹窗被拦截，请允许弹窗后重试。",
  "session.quickstart.browser_opened_url": "已打开：{url}",
  "session.quickstart.browser_invalid_url": "URL 或端口格式不正确。",
  "session.quickstart.browser_cancelled": "已取消打开浏览器。",
  "session.quickstart.sent_to_chat": "快捷指令已发送。",
  "session.quickstart.connect_first": "请先连接工作区。",
  "session.quickstart.send_failed": "快捷指令发送失败。",
  "session.quickstart.browser_automation_title": "自动化浏览器",
  "session.quickstart.browser_automation_description": "配置浏览器自动化并在 OpenWork 中稳定执行网页任务。",
  "session.quickstart.soul_title": "Give me a soul",
  "session.quickstart.soul_description": "通过轻量定时检查在多次会话之间保留你的目标与偏好。",
  "session.menu.actions": "会话操作",
  "session.menu.select_session_hint": "先选择一个会话再进行管理",
  "session.menu.compact": "压缩会话上下文",
  "session.menu.rename": "重命名会话",
  "session.menu.delete": "删除会话",
  "session.update_available": "有可用更新",
  "session.update_ready": "更新已就绪",
  "session.install_update": "安装更新",
  "session.downloading": "下载中",
  "session.downloading_percent": "下载中 {percent}%",
  "session.update_title_ready_blocked": "更新已就绪 {version}。请先停止正在运行的任务再重启。",
  "session.update_title_ready": "重启以应用更新 {version}",
  "session.update_title_downloading": "正在下载更新 {version}",
  "session.update_title_available": "有可用更新 {version}",
  "session.delete_title": "删除会话？",
  "session.delete_message_named": "这将永久删除“{title}”及其消息记录。",
  "session.delete_message": "这将永久删除所选会话及其消息记录。",
  ...
  "settings.invite_cleared": "邀请码已清除。",
  "settings.invite_manage_title": "邀请码管理",
  "settings.invite_manage_hint": "生成、查看和删除邀请码。每个邀请码仅可成功使用一次，有效期 15 天。",
  "settings.invite_new_label": "新邀请码",
  "settings.invite_new_placeholder": "留空则自动生成",
  "settings.invite_generate": "生成邀请码",
  "settings.invite_created": "邀请码已创建。",
  "settings.invite_deleted": "邀请码已删除。",
  "settings.invite_manage_failed": "邀请码管理失败。",
  "settings.invite_empty": "当前还没有邀请码。",
  "settings.invite_item_meta": "到期：{expires} · 状态：{status}",
  "settings.invite_status_valid": "可用",
  "settings.invite_status_used": "已使用",
  "settings.invite_status_expired": "已过期",
  "settings.preview_title": "浏览器预览地址",
  "settings.preview_hint": "“打开浏览器”会优先尝试这里保存的地址。",
  "settings.preview_label": "默认预览 URL / 端口",
  "settings.preview_placeholder": "例如：127.0.0.1:5173 或 5173",
  "settings.preview_saved": "预览地址已保存。",
  "settings.preview_cleared": "预览地址已清除。",
  "settings.save": "保存",
  "settings.clear": "清除",
  "settings.refresh": "刷新",
  "settings.delete": "删除",
  "settings.auto_compact_label": "自动压缩上下文",
  "settings.auto_compact_hint": "每次运行结束后自动压缩上下文。",
  ...
  "settings.stop_active_runs_to_update": "停止活动运行以更新",
  ...
  "settings.providers_title": "供应商",
  "settings.providers_description": "连接模型与工具所需的服务。",
  "settings.providers_footer_tip": "API key 由 OpenCode 保存在本地。请在「模型」标签中设置默认模型。",

  // Settings – 消息/路由区块
  "settings.messaging_title": "消息路由",
  "settings.messaging_description": "在「Identities」标签中管理 Telegram/Slack 身份与路由绑定。",
  "session.nav_automations": "自动化",
  "session.nav_soul": "灵魂",
  "session.nav_skills": "技能",
  "session.nav_extensions": "扩展",
  "session.nav_messaging": "消息",
  "session.nav_advanced": "高级",
  "workspace.soul_badge": "灵魂",
  "workspace.soul_settings": "灵魂设置",
  "workspace.enable_soul": "启用灵魂",
  "workspace.edit_name": "编辑名称",
  "workspace.share": "分享...",
  "settings.auto_update_label": "自动更新",
  "settings.auto_update_hint": "自动下载更新（会提示你重启应用）",
  ...
  "onboarding.invite_title": "邀请码",
  "onboarding.invite_description": "请输入 Crow5 邀请码以解锁启动选项。",
  "onboarding.invite_label": "邀请码",
  "onboarding.invite_placeholder": "例如：CROW5",
  "onboarding.invite_activate": "激活",
  "onboarding.invite_checking": "校验中...",
  "onboarding.invite_valid": "邀请码校验成功。",
  "onboarding.invite_invalid": "邀请码无效。",
  "onboarding.invite_used": "邀请码已被使用。",
  "onboarding.invite_expired": "邀请码已过期（15 天）。",
  "onboarding.invite_required": "请先输入并激活有效邀请码。",
  ...
  // Onboarding – 导入已有工作区配置
  "onboarding.import_title": "导入",
  "onboarding.import_description": "使用现有的工作区配置。",
  "onboarding.import_files_hint": "只导入 `.opencode` 和 `opencode.json`。",
