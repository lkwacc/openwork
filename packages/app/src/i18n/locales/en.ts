...
export default {
  ...
  "session.default_header_title": "Explore and identify available topics",
  "session.empty_title": "Hello World, Welcome to Crow5",
  "session.empty_description": "Pick a quick action or type below to begin.",
  "session.empty_hint_title": "Quick actions moved to the header",
  "session.empty_hint_description": "Use Start, Build, Run, and Open Browser to the left of Cmd+K.",
  "session.quickstart.start_title": "Start",
  "session.quickstart.start_description": "Analyze this project and prepare an implementation plan.",
  "session.quickstart.start_prompt":
    "Please inspect this project, summarize structure and dependencies, then give me a clear start plan.",
  "session.quickstart.build_title": "Build",
  "session.quickstart.build_description": "Compile/build this project and report errors if any.",
  "session.quickstart.build_prompt":
    "Please run the correct build/compile command for this project and fix build errors step by step.",
  "session.quickstart.run_title": "Run",
  "session.quickstart.run_description": "Start the project and verify it is running normally.",
  "session.quickstart.run_prompt":
    "Please run this project with the correct command, verify startup logs, and tell me the access URL.",
  "session.quickstart.open_browser_title": "Open Browser",
  "session.quickstart.open_browser_description": "Open local preview quickly (tries 5173/3000/8080).",
  "session.quickstart.open_browser_chat_prompt":
    "Please open my running local web app in the browser. Try common local URLs (5173/3000/8080), and tell me the final URL.",
  "session.quickstart.open_browser_chat_prompt_with_url":
    "Please use the browser to open {url}, verify page load status, and tell me what you see.",
  "session.quickstart.open_browser_prompt": "Enter URL to open",
  "session.quickstart.browser_opened": "Opened in browser.",
  "session.quickstart.browser_blocked": "Browser popup blocked. Please allow popups and retry.",
  "session.quickstart.browser_opened_url": "Opened: {url}",
  "session.quickstart.browser_invalid_url": "Invalid URL or port.",
  "session.quickstart.browser_cancelled": "Open browser canceled.",
  "session.quickstart.sent_to_chat": "Quick command sent.",
  "session.quickstart.connect_first": "Connect to a worker first.",
  "session.quickstart.send_failed": "Failed to send quick command.",
  "session.quickstart.browser_automation_title": "Automate your browser",
  "session.quickstart.browser_automation_description": "Set up browser actions and run reliable web tasks from OpenWork.",
  "session.quickstart.soul_title": "Give me a soul",
  "session.quickstart.soul_description":
    "Keep your goals and preferences across sessions with light scheduled check-ins.",
  "session.menu.actions": "Session actions",
  "session.menu.select_session_hint": "Select a session to manage it",
  "session.menu.compact": "Compact session context",
  "session.menu.rename": "Rename session",
  "session.menu.delete": "Delete session",
  ...
  "session.update_title_ready_blocked": "Update ready {version}. Stop active runs to restart.",
  "session.update_title_ready": "Restart to apply update {version}",
  "session.update_title_downloading": "Downloading update {version}",
  "session.update_title_available": "Update available {version}",
  "session.delete_title": "Delete session?",
  "session.delete_message_named": "This will permanently delete \"{title}\" and its messages.",
  "session.delete_message": "This will permanently delete the selected session and its messages.",
  // ==================== Commands ====================
  "commands.new": "New",
  ...
  "settings.invite_cleared": "Invite code cleared.",
  "settings.invite_manage_title": "Invite Management",
  "settings.invite_manage_hint": "Generate, review, and delete invite codes. Each code can be used once and expires after 15 days.",
  "settings.invite_new_label": "New invite code",
  "settings.invite_new_placeholder": "Leave empty to auto-generate",
  "settings.invite_generate": "Generate invite",
  "settings.invite_created": "Invite code created.",
  "settings.invite_deleted": "Invite code deleted.",
  "settings.invite_manage_failed": "Failed to manage invite codes.",
  "settings.invite_empty": "No invite codes yet.",
  "settings.invite_item_meta": "Expires: {expires} · Status: {status}",
  "settings.invite_status_valid": "Valid",
  "settings.invite_status_used": "Used",
  "settings.invite_status_expired": "Expired",
  "settings.preview_title": "Browser Preview Address",
  "settings.preview_hint": "Open Browser tries this saved address first.",
  "settings.preview_label": "Default preview URL / port",
  "settings.preview_placeholder": "e.g. 127.0.0.1:5173 or 5173",
  "settings.preview_saved": "Preview address saved.",
  "settings.preview_cleared": "Preview address cleared.",
  "settings.save": "Save",
  "settings.clear": "Clear",
  "settings.refresh": "Refresh",
  "settings.delete": "Delete",
  "settings.auto_compact_label": "Auto context compaction",
  "settings.auto_compact_hint": "Automatically compact context after each run completes.",
  ...
  "settings.stop_active_runs_to_update": "Stop active runs to update",
  ...
  "settings.providers_footer_tip": "API keys are stored locally by OpenCode. Set your default model in the Model tab.",

  // Settings – Messaging section
  "settings.messaging_title": "Messaging",
  "settings.messaging_description": "Manage Telegram/Slack identities and bindings in the Identities tab.",
  "session.nav_automations": "Automations",
  "session.nav_soul": "Soul",
  "session.nav_skills": "Skills",
  "session.nav_extensions": "Extensions",
  "session.nav_messaging": "Messaging",
  "session.nav_advanced": "Advanced",
  "workspace.soul_badge": "Soul",
  "workspace.soul_settings": "Soul settings",
  "workspace.enable_soul": "Enable soul",
  "workspace.edit_name": "Edit name",
  ...
  "onboarding.invite_title": "Invite Code",
  "onboarding.invite_description": "Enter your Crow5 invite code to unlock startup options.",
  "onboarding.invite_label": "Invite code",
  "onboarding.invite_placeholder": "e.g. CROW5",
  "onboarding.invite_activate": "Activate",
  "onboarding.invite_checking": "Checking...",
  "onboarding.invite_valid": "Invite code verified.",
  "onboarding.invite_invalid": "Invalid invite code.",
  "onboarding.invite_used": "Invite code has already been used.",
  "onboarding.invite_expired": "Invite code expired after 15 days.",
  "onboarding.invite_required": "Please enter a valid invite code first.",
  ...
  // Onboarding – import existing workspace config
  "onboarding.import_title": "Import",
  "onboarding.import_description": "Use an existing workspace config.",
  "onboarding.import_files_hint": "Imports `.opencode` and `opencode.json` only.",
